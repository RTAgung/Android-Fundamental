...
class GetCurrentWeatherJobService : JobService() {
    ...
    companion object {
        ...
        internal const val CITY = "Lubuklinggau"

        internal const val APP_ID = "6b81df04fbc462191097fcb18ef4e3f4"
    }

    override fun onStartJob(params: JobParameters?): Boolean {
        Log.d(TAG, "onStartJob()")
        params?.let { getCurrentWeather(it) }
        return true
    }
    ...
    private fun getCurrentWeather(job: JobParameters) {
        Log.d(TAG, "getCurretWeather: Mulai.....")
